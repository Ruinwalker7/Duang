...
<head>
  ...
  <meta name="description" content="青菜萝卜 | 关于本站">
  <meta name="keywords" content="青菜萝卜,关于本站">
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
  <title>关于本站  | 青菜萝卜胡丁程序员技术分享博客</title>
...
<body id="blog">
			...
			<nav class="am-g am-g-fixed qing-fixed qing-nav">
			  ...
			  <div class="am-collapse am-topbar-collapse" id="blog-collapse">
			    <ul class="am-nav am-nav-pills am-topbar-nav">
			      ...
			      <li class="am-active"><a href="about.html"><i class="am-icon-info"></i> 关于本站</a></li>
	...
	<div class="am-g am-g-fixed qing-fixed qing-container">
		<!-- left content start-->
    <div class="am-u-md-8 am-u-sm-12 am-u-md-centered am-u-sm-centered">
    	<!-- 通知公告开始 -->
			<div id="qing-notice-cnt"></div>
			<!-- 通知公告结束 -->
    	<!-- header start  -->
    	<div class="qing-content qing-page-header">
    		 <span>关于本站</span>
    	</div>
    	<!-- header end  -->
    	<div class="qing-content qing-about-cnt">
				<!-- about content start -->
				<div>
					<div>
    				<h3><strong>本站简介</strong></h3>
						<p class="qing-about-text">
							本站定位为IT技术博客站，博客内容主要涉及编程语言、机器学习、推荐算法、数据挖掘等方面，同时分享实用的学习和开发资料。嗯嗯嗯，不知道说啥了。外面的世界真精彩!
						</p>
						<hr>
    			</div>
					<div>
		        ...
		        <p class="qing-about-text">
		        	一枚正在努力进步的初级程序员,在校研究生。主要开发语言为Java， Android，Html等。专长领域为Web开发，Android开发，服务器端开发。目前主要研究方向为文本新闻挖掘。
		         </p>
						<hr>
					</div>
					<div>
						<h3><strong>初衷</strong></h3>
						<p class="qing-about-text">写博是一个思考和沉淀的过程。</p>
						<p class="qing-about-text">对内：是一个solution record的地方；是自己的知识仓库。</p>
						<p class="qing-about-text">对外：是别人了解你的最直接方式；是交流、分享经验的平台。</p>
						<hr>
					</div>
					<div>
						<h3><strong>联系方式</strong></h3>
						<p class="qing-about-text">邮箱：hunter@huding.me</p>
						<p class="qing-about-text">新浪微博：<a href="http://weibo.com/p/1005055576062761" target="_blank">http://weibo.com</a></p>
						<p class="qing-about-text">GitHub：<a href="https://github.com/hujianhong" target="_blank">https://github.com</a></p>
					  <hr>
					</div>
					<div>
						<h3><strong>文章版权声明</strong></h3>
						<p class="qing-about-text">1、欢迎转载本站文章，本站文章版权归作者所有，转载请声明原文出处。 请尊重他人劳动成果,共建美好的网络环境。</p>
						<p class="qing-about-text">2、知识共享许可协议 本站作品采用 知识共享署名-相同方式共享 3.0 中国大陆许可协议进行许可。</p>
						<p class="qing-about-text">3、本站转载的文章都有声明作者或文章的来源。但有部分文章找不到相关作者信息，这些文章版权为原作者所有。 如有版权等问题，原作者可发邮件给我以进行处理。</p>
						<hr>
					</div>
					<div>
						<h3><strong>友链互换</strong></h3>
						<p class="qing-about-text">想要互换友链的朋友可以联系我: 1043244432@qq.com。</p>
						<hr>
					</div>
					<div>
						<h3><strong>一句箴言</strong></h3>
						<p class="qing-about-text">天道酬勤，比你优秀的人还在努力</p>
						<hr>
					</div>
    		</div>
    	</div>
  ...
  <script>
  	layui.config({base:'static/js/'}).use('about');
  </script>
